...
const projects = [
  ...
  },
  {
    ...
    description: "Interactive 3D portfolio built with Three.js featuring immersive animations and WebGL effects.",
  ...
  },
  {
    ...
    description: "Real-time cryptocurrency tracking dashboard with advanced charts and portfolio management.",
    tech: ["React", "D3.js", "WebSocket", "TailwindCSS"],

      ...
      >
        <Link to="/">
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-2 px-4 py-2 glass-card rounded-full text-foreground/70 hover:text-primary transition-colors"
          >
            <span className="text-xl">←</span>
            <span className="font-rajdhani uppercase tracking-wider text-sm">Back</span>
          </motion.button>
        </Link>
      </motion.div>
